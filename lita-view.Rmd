...
Code is available (badly commented) on [GitHub](http://github.com/jladams/lita-view), data will be available soon.

Last updated `r stamp("Tuesday, November 15, 2016 at 12:07 pm")(now())`. 
...
* `r sum(tweets_retweets$tweets)-sum(tweets_retweets$retweets)` unique tweets
* `r sum(tweets_retweets$retweets)` retweets
